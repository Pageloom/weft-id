...
## ~~Downstream SP Assertion Preview~~ (Complete)

---

## ~~Upstream IdP Verbose Assertion Logging~~ (Complete)

---

## ~~SAML Assertion Attribute Resilience and Diagnostic Clarity~~ (Complete)

---

## ~~Sync User Attributes from Upstream IdP on Login~~ (Complete)

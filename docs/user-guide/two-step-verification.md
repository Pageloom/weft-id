...
- View your remaining backup codes on the sign-in methods settings page
...
Passkeys are also managed from the sign-in methods page. They are a separate sign-in method that replaces both your password and verification code. See [Passkeys](passkeys.md) for full details on registration, sign-in, and recovery.

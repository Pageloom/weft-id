...
EVENT_TYPE_DESCRIPTIONS: dict[str, str] = {
    ...
    "tenant_attribute_config_read_failed": (
        "Tenant attribute config read failed during SAML SSO; assertion omitted standard attributes"
    ),
    ...
    "oidc_client_disabled": "OIDC disabled on an application",
    "oidc_client_availability_changed": "OIDC application access mode changed",
    "oidc_client_group_assigned": "Group assigned to OIDC application",
    "oidc_client_group_unassigned": "Group unassigned from OIDC application",
    "oidc_client_groups_bulk_assigned": "Multiple groups assigned to OIDC application",
    # OIDC Upstream (relying-party) Connections
    "oidc_idp_connection_created": "OIDC upstream identity provider connection configured",
    "oidc_idp_connection_updated": "OIDC upstream identity provider connection updated",
    "oidc_idp_connection_deleted": "OIDC upstream identity provider connection removed",
    ...
    "oidc_domain_bound": "Email domain bound to OIDC upstream identity provider",
    "oidc_domain_unbound": "Email domain unbound from OIDC upstream identity provider",
    "oidc_domain_rebound": "Email domain rebound to different OIDC upstream identity provider",
    "user_oidc_idp_assigned": "User assigned to OIDC upstream identity provider",
    ...
    "proxy_app_updated": "Forward-auth proxy app configuration updated",
...
EVENT_TYPE_TIERS: dict[str, str] = {
    ...
    "tenant_attribute_config_read_failed": "admin",
    ...
    "oidc_client_disabled": "admin",
    "oidc_client_availability_changed": "admin",
    "oidc_client_group_assigned": "admin",
    "oidc_client_group_unassigned": "admin",
    "oidc_client_groups_bulk_assigned": "admin",
    "oidc_idp_connection_created": "admin",
    "oidc_idp_connection_updated": "admin",
    "oidc_idp_connection_deleted": "admin",
    ...
    "oidc_domain_rebound": "admin",
    "user_oidc_idp_assigned": "admin",
